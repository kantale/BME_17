...
Σε αυτή την άσκηση θα πρέπει να ετοιμάσεται μία αναφορά όπου για κάθε βήμα θα αναφέρετε:
1. Τι τρέξατε
2. Γιατί το τρέξατε
...
### Βήμα 12 (προαιρετικό)
Τώρα που έχουμε φτιάξει ένα φανταστικό aligment αρχείο μπορούμε να το 
