...
Παρατηρήστε ότι με τον 1ο τρόπο προσθέτουμε ΟΛΗ τη δυνατή πληροφορία που υπάρχει (`--everything`) γιατί είναι "φθηνό", αφού η πληροφορία είναι ήδη κατεβασμένη στον υπολογιστή μας. Με τον 2ο τρόπο όμως προσθέτουμε μόνο τη πρόβλεψη της παθογένειας της μετάλλαξης μέσω των προγραμμάτω [polyphen](http://genetics.bwh.harvard.edu/pph2/) και [sift](https://sift.bii.a-star.edu.sg/). Επίσης ελέγχουμε αν η μετάλλαξη υπάρχει σε άλλες βάσεις δεδομένων (`--check_existing`). Επιλέγουμε δηλαδή να προσθέσει την ελάχιστη πληροφορία που θέλουμε, γιατί το να προσθέσουμε πληροφορία είναι "ακριβό". 

Εσείς θα πρέπει να επιλέξετε έναν από τους 2 τρόπους που νομίζετε ότι είναι καλύτερος για τον υπολογιστή σας.
